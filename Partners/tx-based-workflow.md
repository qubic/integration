...
| Method | Endpoint                  | Description                                                                                |
|--------|---------------------------|--------------------------------------------------------------------------------------------|
| POST   | /v1/broadcast-transaction | Broadcast a new transaction to the network. Needs to be base64 encoded.                    |
| POST   | /v1/querySmartContract    | Perform a query on a smart contract function. The request data needs to be base64 encoded. |
